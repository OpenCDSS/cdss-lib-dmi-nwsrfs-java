// ----------------------------------------------------------------------------
// NWSRFS_MAP_CellRenderer - class for rendering cells in the MAP 
...
*/
public NWSRFS_MAP_CellRenderer(NWSRFS_MAP_TableModel model) {
	__tableModel = model;
